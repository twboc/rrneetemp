...
export enum ERROR_CODE  {
    ...
    ERROR_AUTHORIZATION_MISSING = 'ERROR_AUTHORIZATION_MISSING',
    ERROR_AUTHORIZATION_INVALID = 'ERROR_AUTHORIZATION_INVALID'
}
...
export const ERROR_AUTHORIZATION_MISSING = {
    code: ERROR_CODE.ERROR_AUTHORIZATION_MISSING,
    message: 'Authorization missing'
}

export const ERROR_AUTHORIZATION_INVALID = {
    code: ERROR_CODE.ERROR_AUTHORIZATION_INVALID,
